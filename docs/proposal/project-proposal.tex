...
Ideally, the user base will be a combination of the best users from the early days of Reddit, Hacker News, Slashdot, etc., that have been longing for a news aggregation site that shows them precisely what they want to read.
...
We plan to have bi-weekly iterations.
Although 1-week iterations work well for industry, we will use bi-weekly iterations because of the slower pace of the project relative to full-time work.
