...
\section{Application}
\subsection{Frontend}
The frontend is what is commonly thought of as a standard social news aggregator, except that it displays articles on recommendation of the backend.
Upon going to the homepage, new and logged-out users are presented with a splash page that describes the nature of Project October and offers a registration link.
Users can register for the application by inputting their username, an email, and a password.
