...
Users can interact with comments in the same way as they interact with news articles -- voting up, voting down, or commenting on them (in which case a child comment is created).
The votes on comments are submitted to the backend for additional semantic processing.
...
The API is defined in a Thrift definitions file in the project-october-api repository on GitHub\ref{ref:project-october-api}.
